#!/usr/bin/env python3
"""
login_phone.py - login to your app by using just their phone number or email address
"""
...
def getToken(number, code, req_code):
    ...
    r_GetToken = requests.post(TOKEN_URL, data=GetToken_content,
                               headers=GetToken_headers, verify=False)
